...
module.exports = () => {
  ...
  it('Integer as parameter', async () => {
    const { value } = await processInput('log(1) =?')
  ...
  it('Decimal as parameter', async () => {
    const { value } = await processInput('log(1.1) =?')
    const expectedResult = { r: 0.041392685158, i: 0 }
  ...
  it('Numeral as parameter', async () => {
    ...
    const { value } = await processInput('log(x) =?')
    const expectedResult = { r: 0, i: 0 }
  ...
  it('Expression image as parameter', async () => {
    ...
    const { value } = await processInput('log(f(1)) =?')
    const expectedResult = { r: 0, i: 0 }
